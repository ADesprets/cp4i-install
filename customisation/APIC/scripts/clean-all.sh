...
if [ ${CONFIRM} = 'DELETE' ]; then
    ...
    kubectl delete -f updated/apigateway_cr.yaml -n $NAMESPACE
    kubectl delete secret datapower-admin-credentials -n $NAMESPACE
    kubectl delete -f updated/portal_cr.yaml -n $NAMESPACE
    kubectl delete -f updated/analytics_cr.yaml -n $NAMESPACE
    kubectl delete -f updated/management_cr.yaml -n $NAMESPACE
    kubectl delete -f updated/custom-certs-external.yaml -n $NAMESPACE
    kubectl delete -f updated/ibm-datapower.yaml -n $NAMESPACE
    kubectl delete -f updated/ibm-apiconnect.yaml -n $NAMESPACE
    kubectl delete -f updated/ibm-apiconnect-crds.yaml -n $NAMESPACE
