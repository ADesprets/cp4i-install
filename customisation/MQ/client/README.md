...
The code and documentation here is taken from a git hub called mq-dev-patterns that you can access [here](https://github.com/ibm-messaging/mq-dev-patterns/tree/master).
