...
mylog info "Post a message to the queue Q1 in the ${VAR_QMGR} queue manager" 0
...
mylog info "Get a message from the queue Q1 in the ${VAR_QMGR} queue manager" 0
...
mylog info "Get queues for the ${VAR_QMGR} queue manager" 0
...
mylog info "Get channels for the ${VAR_QMGR} queue manager" 0
