...
echo ---------
echo "Delete User $userOrg"
echo ---------

userCLEAR=$(curl -sk --request DELETE "https://$EP_API/api/user-registries/admin/api-manager-lur/users/$ORG_USERNAME" -H "Accept: application/json" -H "authorization: Bearer $cmToken");
