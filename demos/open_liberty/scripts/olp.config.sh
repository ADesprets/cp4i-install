...
function push_image_to_registry() {
  ...
  decho $lf_tracelevel "CMD: $MY_CONTAINER_ENGINE tag ${MY_OPENLIBERTY_APP_NAME_VERSION} ${IMAGE_REGISTRY_HOST}/${VAR_OPENLIBERTY_NAMESPACE}/${MY_OPENLIBERTY_APP_NAME_VERSION}"
